...
<head>
    ...
    <title>Venue Decor | Decorating Site</title>
    <?php wp_head(); ?>
    ...
    <link
        ...
        rel='stylesheet'>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/venue-decor.css">
...
<body>
    ...
    <section class="parent-section">
        <header class="hero-section">
            ...
            <div class="hero-content">
                <h1>Transform Your Venue with <br>Stunning Styling & Decor </h1>
                <div class="hero-img">
                    <a href="https://brisbaneeventdecorators.com.au/#event-plan" class="hero-top-btn">See Details</a>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/vd-desk.png" class="hero-desk" alt="">
    ...
    <div class="event-blns">
        <div class="eb-child">
            <h2>Creating Memorable Spaces for Every Occasion</h2>
            <p>Bring your vision to life with our professional venue styling and décor services. Whether it’s a wedding, corporate event, or private celebration, we design breathtaking spaces that leave a lasting impression.</p>

            <div class="eb-sub-child">
                <div class="eb-left">
                    <h2>Why Choose Us for Venue Styling & Decor?</h2>
                    <h3>Tailored Styling:</h3>
                    <p>Decor customized to suit your theme and preferences.</p>
                    <h3>Creative Expertise:</h3>
                    <p>Innovative ideas that enhance your venue’s aesthetics.</p>
                    <h3>Comprehensive Service: </h3>
                    <p>From concept to execution, we handle every detail.</p>
                    <h3>High-Quality Decor:</h3>
                    <p>Elegant props and premium materials for a polished look.</p>
                    <h3>Seamless Execution: </h3>
                    <p>Timely setup and flawless coordination.</p>
                </div>
                <div class="eb-right">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/vd1.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="occations-child">
            ...
            <div class="oc-right">
                <div class="slider-container">
                    <div class="slider">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/vd2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/vd2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/vd2.png" alt="Image 1">
                    </div>
