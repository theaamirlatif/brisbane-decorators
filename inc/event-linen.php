...
<head>
    ...
    <title>Event Linen | Decorating Site</title>
    <?php wp_head(); ?>
    ...
    <link
        ...
        rel='stylesheet'>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/event-linen.css">
...
<body>
    ...
    <section class="parent-section">
        <header class="hero-section">
            ...
            <div class="hero-content">
                <h1>Event Linen Rentals for Every <br>Occasion </h1>
                <div class="hero-img">
                    <a href="https://brisbaneeventdecorators.com.au/#event-plan" class="hero-top-btn">See Details</a>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/eld-desk.png" class="hero-desk" alt="">
    ...
    <div class="event-blns">
        <div class="eb-child">
            <h2>Premium Linens to Elevate Your Event Decor</h2>
            <p>Transform your event with luxurious linens, including tablecloths, napkins, and chair covers, available in a variety of colors, fabrics, and styles to suit any theme.</p>

            <div class="eb-sub-child">
                <div class="eb-left">
                    <h2>Why Choose Our Balloon Styling Services?</h2>
                    <h3>Premium Fabrics:</h3>
                    <p>Durable and elegant materials for a flawless look.</p>
                    <h3>Customizable Styles:</h3>
                    <p>Choose from a wide range of colors and textures.</p>
                    <h3>Perfect Fit: </h3>
                    <p>Linens tailored to match your tables and chairs.</p>
                    <h3>Premium Fabrics:</h3>
                    <p>Durable and elegant materials for a flawless look.</p>
                    <h3>Customizable Styles: </h3>
                    <p>Choose from a wide range of colors and textures.</p>
                ...
                <div class="eb-right">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/eld1.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="occations-child">
            ...
            <div class="oc-right">
                <div class="slider-container">
                    <div class="slider">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/eld2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/eld2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/eld2.png" alt="Image 1">
                    </div>
