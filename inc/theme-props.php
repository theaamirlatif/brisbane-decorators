...
<head>
    ...
    <title>Theme Props | Decorating Site</title>
    <?php wp_head(); ?>
    ...
    <link
        ...
        rel='stylesheet'>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/theme-props.css">
...
<body>
    ...
    <section class="parent-section">
        <header class="hero-section">
            ...
            <div class="hero-content">
                <h1>Themed Props & Installations for <br>Unforgettable Events </h1>
                <div class="hero-img">
                    <a href="https://brisbaneeventdecorators.com.au/#event-plan" class="hero-top-btn">See Details</a>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/tp-desk.png" class="hero-desk" alt="">
    ...
    <div class="event-blns">
        <div class="eb-child">
            <h2>Bring Your Vision to Life with Custom Props and Designs</h2>
            <p>Enhance your event with themed props and immersive installations that create a lasting impact. Whether it’s a whimsical wedding, a corporate gala, or a themed party, we design setups that captivate and inspire.</p>

            <div class="eb-sub-child">
                <div class="eb-left">
                    <h2>Why Choose Us for Themed Props & Installations?</h2>
                    <h3>Tailored Styling:</h3>
                    <p>Props and installations tailored to match your theme.</p>
                    <h3>Premium Quality:</h3>
                    <p>Stunning, durable pieces built with precision.</p>
                    <h3>Seamless Installation: </h3>
                    <p>Professional setup to bring your vision to life.</p>
                    <h3>Creative Expertise:</h3>
                    <p>Innovative ideas for unforgettable event decor.</p>
                    <h3>Affordable Options: </h3>
                    <p>Exceptional designs at competitive prices.</p>
                </div>
                <div class="eb-right">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/tp1.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="occations-child">
            ...
            <div class="oc-right">
                <div class="slider-container">
                    <div class="slider">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/tp2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/tp2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/tp2.png" alt="Image 1">
                    </div>
