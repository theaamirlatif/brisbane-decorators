...
<head>
    ...
    <title>Backdrop | Decorating Site</title>
    <?php wp_head(); ?>
    ...
    <link
        ...
        rel='stylesheet'>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/backdrop.css">
...
<body>
    ...
    <section class="parent-section">
        <header class="hero-section">
            ...
            <div class="hero-content">
                <h1>Transform Your Event with <br>Custom Backdrops </h1>
                <div class="hero-img">
                    <a href="https://brisbaneeventdecorators.com.au/#event-plan" class="hero-top-btn">See Details</a>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/bd-desk.png" class="hero-desk" alt="">
    ...
    <div class="event-blns">
        <div class="eb-child">
            <h2>Stunning Backdrop Services for Every Event</h2>
            <p>Transform your event with beautifully designed backdrops that add charm and elegance to any occasion. From weddings to corporate events, we craft custom backdrops tailored to your style and theme.</p>

            <div class="eb-sub-child">
                <div class="eb-left">
                    <h2>Why Choose Our Backdrop Services?</h2>
                    <h3>Custom Creations:</h3>
                    <p>Backdrops designed to match your vision and theme.</p>
                    <h3>High-Quality Materials:</h3>
                    <p>Durable and stylish backdrops for a polished look.</p>
                    <h3>Versatile Styles: </h3>
                    <p>Suitable for photos, ceremonies, and event focal points.</p>
                    <h3>Professional Setup:</h3>
                    <p>Seamless installation for a hassle-free experience.</p>
                    <h3>Affordable Options: </h3>
                    <p>Beautiful backdrops to fit any budget.</p>
                </div>
                <div class="eb-right">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/bd1.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="occations-child">
            ...
            <div class="oc-right">
                <div class="slider-container">
                    <div class="slider">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/bd2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/bd2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/bd2.png" alt="Image 1">
                    </div>
