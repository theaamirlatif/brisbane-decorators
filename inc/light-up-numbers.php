<?php
/*
Template Name: Light Up Numbers
*/ 
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Light Up Numbers | Decorating Site</title>
    <?php wp_head(); ?>
    ...
    <link
        href='https://fonts.googleapis.com/css?family=Elsie|Oswald|PT Sans|Inter|Kumbh Sans|Fira Sans|Playfair Display SC|Urbanist|Playfair Display|Poppins'
        rel='stylesheet'>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/light-up-numbers.css">
...
<body>
    ...
    <section class="parent-section">
        <header class="hero-section">
            ...
            <div class="ln-event-blns">
                <div class="ln-eb-child">
                    <div class="ln-eb-sub-child">
                        <div class="ln-eb-right">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hero-img1.png" alt="">
                            <div class="more-images">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hero-img2.png" alt="">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hero-img2.png" alt="">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hero-img2.png" alt="">
                            </div>
                        </div>
                        <div class="ln-eb-left">
                            <h1>hire the best light-up numbers service for your event or business</h1>
                            <div class="rating-feedback">
                                ...
                                <span class="txts">(4.9/5)</span>
                                <span class="txts">500+ Reviews</span>
                                <span class="txts">1700+ Solds</span>
                            </div>
                            <div class="splash-texts">
                                <div class="single-text">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/splash.png" alt="" > <h4>Durable & Reliable</h4>
                                </div>
                                <div class="single-text">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/splash.png" alt="" > <h4>Customizable Options</h4>
                                </div>
                                <div class="single-text">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/splash.png" alt="" > <h4>Eye-Catching Design</h4>
                                </div>
                            </div>
                            <p>Transform any event or space with custom light-up letters that make a bold statement. Whether for a wedding, corporate event, storefront, or home decor, we offer high-quality, personalized illuminated signs that bring your vision to life. Rent It today!</p>
                            <span class="highlight">EACH letter 120$ Delivery excluded and is extra </span>
                            <form id="quote-request-form" class="form-horizontal" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post">
                                ...
                                <input type="number" name="eNum" placeholder="Number Required" required>
    ...
    <div class="event-blns">
        <div class="eb-child">
            <h2>Personalized Designs That Make a Statement</h2>
            <p>Add a personal touch to your event with beautifully designed custom signage and printables. From elegant welcome boards to themed table cards, we create unique pieces that enhance your event's style and message.</p>
            <div class="hero-content">
                <!--<h1>Custom Signage & Printables for <br>Every Event </h1>-->
                <div class="hero-img">
                    <a href="#" class="hero-top-btn">See Details</a>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/big-img.png" class="hero-desk" alt="">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/mob-hero.png" class="hero-mob" alt="">
                    <a href="#" class="hero-bot-btn"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/ci_chevron-up-duo.png" alt=""></a>
                </div>
            </div>
            <div class="eb-sub-child">
                <div class="eb-left">
                    <h2>Why Choose Us for Custom Signage & Printables?</h2>
                    <h3>Personalized Designs:</h3>
                    <p>Crafted to match your theme and vision.</p>
                    <h3>High-Quality Materials:</h3>
                    <p>Durable and stylish prints for every setting.</p>
                    <h3>Wide Range of Options: </h3>
                    <p>From menus and seating charts to directional signs.</p>
                    <h3>Creative Expertise:</h3>
                    <p>Unique ideas that leave a lasting impression.</p>
                    <h3>Affordable Options: </h3>
                    <p>Custom pieces to fit every budget.</p>
                </div>
                <div class="eb-right">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ln1.png" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="event-plan-cat">
        <div id="event-plan" class="event-plan-cat-child">
            <span>Discover high-quality designs that reflect your unique style.</span>
            <h2>Exclusive Products Tailored Just for You!</h2>
            <div class="lu-products">
                <div class="product">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/lun-p1.jpg" alt="Product 1" class="product-img">
                    <h3 class="product-title" title="Birthday Party Light Up Numbers">Birthday Party Light Up Numbers</h3>
                    <p class="product-price">$19.99</p>
                    <a href="#" class="checkout-btn">Checkout</a>
                </div>
                <div class="product">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/lun-p2.jpg" alt="Product 2" class="product-img">
                    <h3 class="product-title" title="Wedding Aniversary Light Up Numbers">Wedding Aniversary Light Up Numbers</h3>
                    <p class="product-price">$29.99</p>
                    <a href="#" class="checkout-btn">Checkout</a>
                </div>
                <div class="product">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/lun-p3.jpg" alt="Product 3" class="product-img">
                    <h3 class="product-title" title="Shining Event Sign Party Decor">Shining Event Sign Party Decor</h3>
                    <p class="product-price">$39.99</p>
                    <a href="#" class="checkout-btn">Checkout</a>
                </div>
                <div class="product">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/lun-p4.jpg" alt="Product 4" class="product-img">
                    <h3 class="product-title" title="New Year's Eve Bright Party Decor">New Year's Eve Bright Party Decor</h3>
        ...
        <div class="occations-child">
            ...
            <div class="oc-right">
                <div class="slider-container">
                    <div class="slider">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ln2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ln2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ln2.png" alt="Image 1">
                    </div>
