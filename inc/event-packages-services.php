<?php
/*
Template Name: Event Packages Services
*/ 
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Event Packages Services | Decorating Site</title>
    <?php wp_head(); ?>
    ...
    <link
        ...
        rel='stylesheet'>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/event-packages-services.css">
        ...
        <header class="hero-section">
            ...
            <div class="hero-content">
                <div class="hero-img">
                    ...
                    <h1>Our Event Packages Service!</h1>
                </div>
            </div>
        </header>
    </section>
        ...
        <div id="event-plan" class="event-plan-cat-child">
            ...
            <div class="epc-bot"> 
                ...
                <div class="epc-bot-child" style="display: flex; background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/srvc2.png');">
                    ...
                    <div class="epc-bot-text">
                        <h3>Grab & go diy’s</h3>
                        <p>Effortless and Fun DIY Kits for Your Next Event or Celebration</p>
                    </div>
                </div>
                <div class="epc-bot-child" style="display: flex; background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/srvc3.png');">
                    <a href="https://brisbaneeventdecorators.com.au/luxury-chauffeur/"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/Huge-icon.png" alt=""></a>
                    <div class="epc-bot-text">
                        <h3>Chauffeur services</h3>
                        <p>Luxury Chauffeur Services for a Comfortable and Stylish Journey</p>
                    </div>
                </div>
                <div class="epc-bot-child" style="display: flex; background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/srvc4.png');">
                    ...
                    <div class="epc-bot-text">
                        <h3>picnics</h3>
                        <p>Relax and Enjoy in Style with Our Curated Picnic Experiences</p>
                    </div>
                </div>
                ...
                <div class="epc-bot-child" style="display: flex; background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/srvc6.png');">
                    ...
                    <div class="epc-bot-text">
                        <h3>Table setting and centerpieces</h3>
                ...
                <div class="epc-bot-child" style="display: flex; background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/srvc7.png');">
                    <a href="https://brisbaneeventdecorators.com.au/theme-props/"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/Huge-icon.png" alt=""></a>
                    <div class="epc-bot-text">
                        <h3>Themed props and installation</h3>
                ...
                <div class="epc-bot-child" style="display: flex; background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/srvc8.png');">
                    ...
                    <div class="epc-bot-text">
                        <h3>Customize signage & printable</h3>
                        <p>Personalize Your Event with Tailored Signage and Printables</p>
                    </div>
                </div>
                <div class="epc-bot-child" style="display: flex; background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/srvc9.png');">
                    ...
                    <div class="epc-bot-text">
                        <h3>Light up numbers letters & table letters</h3>
                        <p>Add Sparkle and Style with Our Light-Up Numbers and Letters for Every Occasion</p>
                    </div>
                </div>
                ...
                <div class="epc-bot-child" style="display: none; background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/srvc12.png');">
                    <a href="https://brisbaneeventdecorators.com.au/light-up-letters/"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/Huge-icon.png" alt=""></a>
                    <div class="epc-bot-text">
                        <h3>Light up letters</h3>
                        <p>Add charm to your event with customizable, durable, and eye-catching light-up letters, perfect for any celebration!</p>
                    </div>
                </div>
                <div class="epc-bot-child" style="display: none; background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/srvc13.png');">
                    ...
                    <div class="epc-bot-text">
                        <h3>Standard colors balloon styling</h3>
                        <p>Create a timeless look with our standard color balloon styling, perfect for elegant arches, garlands, and centerpieces at any event!</p>
                    </div>
                </div>
                <div class="epc-bot-child" style="display: none; background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/srvc14.png');">
                    ...
                    <div class="epc-bot-text">
                        <h3>Custom colors balloon styling</h3>
