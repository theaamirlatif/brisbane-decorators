...
<head>
    ...
    <title>Engagement | Decorating Site</title>
    <?php wp_head(); ?>
    ...
    <link
        ...
        rel='stylesheet'>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/engagement.css">
...
<body>
    ...
    <section class="parent-section">
        <header class="hero-section">
            ...
            <div class="hero-content">
                <h1>Celebrate Love with Stunning <br>Engagement Decor </h1>
                <div class="hero-img">
                    <a href="https://brisbaneeventdecorators.com.au/#event-plan" class="hero-top-btn">See Details</a>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/e-des.png" class="hero-desk" alt="">
    ...
    <div class="event-blns">
        <div class="eb-child">
            ...
            <p>Set the perfect stage for your love story with elegant and customizable decor designed to reflect your unique journey.</p>

            <div class="eb-sub-child">
                <div class="eb-left">
                    <h2>Why Choose Us for Engagement Decor?</h2>
                    <h3>Customized Themes </h3>
                    <p>Whether classic, rustic, or modern, we provide props tailored to your dream aesthetic.matches your vision.</p>
                    <h3>Exclusive Collections:</h3>
                    <p>Unique and high-quality decor items to make your event stand out.</p>
                    <h3>Stress-Free Rentals: </h3>
                    <p>Easy booking, timely delivery, and setup for a seamless experience.</p>
                    <h3>Affordable Luxury:</h3>
                    <p>Premium designs at prices that won’t break the bank.</p>
                    <h3>Memorable Moments: </h3>
                    <p>Capture stunning photos and create lasting memories with enchanting setups.</p>
                </div>
                <div class="eb-right">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/eng1.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="occations-child">
            <div class="oc-left">
                ...
                <div class="oc-ul-parent">
                    <ul>
                        <li>Intimate Home Gatherings</li>
                        <li>Grand Venue Celebrations</li>
                        <li>Outdoor and Destination Engagements</li>
                    </ul>
                </div>
            </div>
            <div class="oc-right">
                <div class="slider-container">
                    <div class="slider">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/eng2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/eng2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/eng2.png" alt="Image 1">
                    </div>
