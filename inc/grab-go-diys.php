...
<head>
    ...
    <title>Grab Go Diys | Decorating Site</title>
    <?php wp_head(); ?>
    ...
    <link
        ...
        rel='stylesheet'>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/grab-go-diys.css">
...
<body>
    ...
    <section class="parent-section">
        <header class="hero-section">
            ...
            <div class="hero-content">
                <h1>Grab & Go DIY Decor <br>Solutions </h1>
                <div class="hero-img">
                    <a href="https://brisbaneeventdecorators.com.au/#event-plan" class="hero-top-btn">See Details</a>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ggd-desk.png" class="hero-desk" alt="">
    ...
    <div class="event-blns">
        <div class="eb-child">
            <h2>Effortless Décor for Your Creative Touch</h2>
            <p>Perfect for those who love to personalize their events, our Grab & Go DIY options let you choose from a variety of pre-designed decor pieces. Pick up, style your way, and create stunning setups with ease.</p>

            <div class="eb-sub-child">
                <div class="eb-left">
                    <h2>Why Choose Our Grab & Go DIYs?</h2>
                    <h3>Ready-to-Use Décor:</h3>
                    <p>High-quality, pre-curated decor items for any event.</p>
                    <h3>Personalized Touch:</h3>
                    <p>Add your creativity to make every piece uniquely yours.</p>
                    <h3>Convenient Pickup & Return: </h3>
                    <p>Easy to collect, easy to drop off.</p>
                    <h3>Cost-Effective Options:</h3>
                    <p>Stunning decor at a fraction of the price.</p>
                    <h3>Diverse Themes: </h3>
                    <p>Suitable for weddings, parties, showers, and more.</p>
                </div>
                <div class="eb-right">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ggd1.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="occations-child">
            ...
            <div class="oc-right">
                <div class="slider-container">
                    <div class="slider">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ggd2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ggd2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ggd2.png" alt="Image 1">
                    </div>
