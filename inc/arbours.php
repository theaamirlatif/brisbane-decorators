...
<head>
    ...
    <title>Arbours | Decorating Site</title>
    <?php wp_head(); ?>
    ...
    <link
        ...
        rel='stylesheet'>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/arbours.css">
...
<body>
    ...
    <section class="parent-section">
        <header class="hero-section">
            ...
            <div class="hero-content">
                <h1>Elevate Your Event with <br>Stunning Arbours </h1>
                <div class="hero-img">
                    <a href="https://brisbaneeventdecorators.com.au/#event-plan" class="hero-top-btn">See Details</a>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/arb-desk.png" class="hero-desk" alt="">
    ...
    <div class="event-blns">
        <div class="eb-child">
            <h2>Elegant Arbours for Every Occasion</h2>
            <p>Enhance your special day with beautifully crafted arbours that create a stunning focal point for your ceremony or celebration. From classic to modern designs, our arbours add charm and elegance to any setting.</p>

            <div class="eb-sub-child">
                <div class="eb-left">
                    <h2>Why Choose Our Arbours Services?</h2>
                ...
                <div class="eb-right">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/arb1.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="occations-child">
            ...
            <div class="oc-right">
                <div class="slider-container">
                    <div class="slider">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/arb2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/arb2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/arb2.png" alt="Image 1">
                    </div>
