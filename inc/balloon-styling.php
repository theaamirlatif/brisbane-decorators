...
<head>
    ...
    <title>Balloon Styling | Decorating Site</title>
    <?php wp_head(); ?>
    ...
    <link
        ...
        rel='stylesheet'>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/balloon-styling.css">
    ...
    <section class="parent-section">
        <header class="hero-section">
            ...
            <div class="hero-content">
                <h1>Professional Planning for <br>Successful Events.</h1>
                <div class="hero-img">
                    <a href="https://brisbaneeventdecorators.com.au/#event-plan" class="hero-top-btn">See Details</a>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/hero-img.png" class="hero-desk" alt="">
    ...
    <div class="event-blns">
        <div class="eb-child">
            ...
            <div class="eb-sub-child">
                ...
                <div class="eb-right">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/eb-img.png" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="ss-review-slider-wrapper">
                <div class="ss-review-slider">
                    <div class="ss-review-col">
                        <div class="ss-review-col-wrapper">
                            <div class="ss-review-img-wrapper">
                                <a href="https://brisbaneeventdecorators.com.au/standard-balloon/" alt="">
                                    <div class="ss-review-header">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ss-img1.png" alt="Pest Control">
                                        <h4>Standard Colors Balloon stying </h4>
                                    </div> 
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="ss-review-col">
                        <div class="ss-review-col-wrapper">
                            <div class="ss-review-img-wrapper">
                                <a href="https://brisbaneeventdecorators.com.au/custom-balloon/" alt="">
                                    <div class="ss-review-header">
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ss-img2.png" alt="Pest Control">
                                        <h4>Custom Color Balloon stying </h4>
                                    </div> 
                                </a>
                            </div>
                        </div>
        ...
        <div class="occations-child">
            ...
            <div class="oc-right">
                <div class="slider-container">
                    <div class="slider">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/oc-img.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/oc-img.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/oc-img.png" alt="Image 1">
                    </div>
