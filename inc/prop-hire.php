...
<head>
    ...
    <title>Prop Hire | Decorating Site</title>
    <?php wp_head(); ?>
    ...
    <link
        ...
        rel='stylesheet'>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/prop-hire.css">
...
<body>
    ...
    <section class="parent-section">
        <header class="hero-section">
            ...
            <div class="hero-content">
                <h1>Premium Prop Hire for Every <br>Occasion </h1>
                <div class="hero-img">
                    <a href="https://brisbaneeventdecorators.com.au/#event-plan" class="hero-top-btn">See Details</a>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ph-desk.png" class="hero-desk" alt="">
    ...
    <div class="event-blns">
        <div class="eb-child">
            ...
            <p>Whether you're planning a photoshoot, film production, event, or theatrical performance, our wide selection of high-quality props will bring your creative vision to life.</p>

            <div class="eb-sub-child">
                <div class="eb-left">
                    <h2>Why Choose Our Balloon Styling Services?</h2>
                    <h3>Extensive Collection: </h3>
                    <p>From vintage to modern, we have props for every theme and occasion.</p>
                    <h3>Customizable Options:</h3>
                    <p>Tailor our props to suit your specific needs.</p>
                    <h3>Expert Support: </h3>
                    <p>Our experienced team helps you find the perfect pieces.</p>
                    <h3>Reliable Service:</h3>
                    <p>Count on us for timely delivery and hassle-free rentals.</p>
                    <h3>Affordable Pricing: </h3>
                    <p>Premium props that fit your budget.</p>
                </div>
                <div class="eb-right">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ph1.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="occations-child">
            ...
            <div class="oc-right">
                <div class="slider-container">
                    <div class="slider">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ph2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ph2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/ph2.png" alt="Image 1">
                    </div>
