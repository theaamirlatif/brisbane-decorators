<?php
/*
Template Name: Standard Balloon
*/ 
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Standard Balloon | Decorating Site</title>
    <?php wp_head(); ?>
    ...
    <link
        ...
        rel='stylesheet'>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/standard-balloon.css">
        ...
        <header class="hero-section">
            ...
            <div class="hero-content">
                ...
                <div class="hero-img">
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/sb-hero.png" class="hero-desk" alt="">
    ...
    <div class="event-blns">
        <div class="eb-child">
            ...
            <div class="eb-sub-child">
                ...
                <div class="eb-right">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/sb1.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="occations-child">
            ...
            <div class="oc-right">
                <div class="slider-container">
                    <div class="slider">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/sb2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/sb2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/sb2.png" alt="Image 1">
                    </div>
    ...
    <div class="footer">
        <div class="footer-child">
            ...
            <div class="flinks">
                <h2>Services</h2>
                <ul>
                    <a href="https://brisbaneeventdecorators.com.au/corporate/"><li>Corporate</li></a>
                    <a href="https://brisbaneeventdecorators.com.au/engagement/"><li>Engagements</li></a>
                    <a href="https://brisbaneeventdecorators.com.au/wedding/"><li>Weddings</li></a>
                    <a href="https://brisbaneeventdecorators.com.au/baby-shower/"><li>Baby Shower</li></a>
