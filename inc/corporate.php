...
<head>
    ...
    <title>Corporate | Decorating Site</title>
    <?php wp_head(); ?>
    ...
    <link
        ...
        rel='stylesheet'>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/corporate.css">
...
<body>
    ...
    <section class="parent-section">
        <header class="hero-section">
            ...
            <div class="hero-content">
                <h1>Elevate Your Corporate Events <br>with Stunning Décor </h1>
                <div class="hero-img">
                    <a href="https://brisbaneeventdecorators.com.au/#event-plan" class="hero-top-btn">See Details</a>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/cp-desk.png" class="hero-desk" alt="">
    ...
    <div class="event-blns">
        <div class="eb-child">
            <h2>Professional and Creative Décor for Every Business Occasion</h2>
            <p>From conferences to corporate galas, our event décor services create a lasting impression. Enhance your brand image, engage your guests, and transform your corporate event into a memorable experience.</p>

            <div class="eb-sub-child">
                <div class="eb-left">
                    <h2>Why Choose Us for Corporate Event Décor?</h2>
                    <h3>Brand-Focused Designs:</h3>
                    <p>Custom decor that reflects your company’s identity and values.</p>
                    <h3>Professional Execution:</h3>
                    <p>High-quality décor with flawless setup and teardown.</p>
                    <h3>Innovative Concepts: </h3>
                    <p>Fresh, creative ideas to make your event stand out.</p>
                    <h3>Seamless Service:</h3>
                    <p>Let us handle every detail, so you can focus on your business.</p>
                    <h3>Budget-Friendly Options: </h3>
                    <p>Premium decor at a price you’ll love.</p>
                </div>
                <div class="eb-right">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/cp1.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="occations-child">
            ...
            <div class="oc-right">
                <div class="slider-container">
                    <div class="slider">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/cp2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/cp2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/cp2.png" alt="Image 1">
                    </div>
