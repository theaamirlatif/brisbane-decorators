...
<head>
    ...
    <title>Gender Reveal | Decorating Site</title>
    <?php wp_head(); ?>
    ...
    <link
        ...
        rel='stylesheet'>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/gender-reveal.css">
...
<body>
    ...
    <section class="parent-section">
        <header class="hero-section">
            ...
            <div class="hero-content">
                <h1>Celebrate the Big Surprise in <br>Style </h1>
                <div class="hero-img">
                    <a href="https://brisbaneeventdecorators.com.au/#event-plan" class="hero-top-btn">See Details</a>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/e-desk.png" class="hero-desk" alt="">
    ...
    <div class="event-blns">
        <div class="eb-child">
            <h2>Creative Gender Reveal Décor for a Memorable Moment</h2>
            <p>Make your gender reveal party truly special with enchanting decor that sets the stage for your big announcement. From whimsical themes to elegant designs, we bring your vision to life.</p>

            <div class="eb-sub-child">
                <div class="eb-left">
                    <h2>Why Choose Us for Gender Reveal Decor?</h2>
                    <h3>Custom Themes:</h3>
                    <p>Tailored decor to match your style.</p>
                    <h3>Creative Concepts:</h3>
                    <p>Unique ideas like balloon arches and reveal boxes.</p>
                    <h3>Picture-Perfect Setup: </h3>
                    <p>Backdrops and props for memorable photos.</p>
                    <h3>Hassle-Free Service:</h3>
                    <p>Relax while we handle the planning, setup, and teardown with precision.</p>
                    <h3>Affordable Packages: </h3>
                    <p>Celebrate in style without exceeding your budget.</p>
                </div>
                <div class="eb-right">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/e1.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="occations-child">
            <div class="oc-left">
                ...
                <div class="oc-ul-parent">
                    <ul>
                        <li>Indoor Celebrations</li>
                        <li>Outdoor Gatherings</li>
                        <li>Themed Venues</li>
                    </ul>
            ...
            <div class="oc-right">
                <div class="slider-container">
                    <div class="slider">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/e2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/e2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/e2.png" alt="Image 1">
                    </div>
