<?php
/*
Template Name: Table Centerpiece
*/ 
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Table Centerpiece | Decorating Site</title>
    <?php wp_head(); ?>
    ...
    <link
        ...
        rel='stylesheet'>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/table-centerpiece.css">
...
<body>
    ...
    <section class="parent-section">
        <header class="hero-section">
            ...
            <div class="hero-content">
                <h1>Elegant Table Settings & Stunning <br>Centerpieces </h1>
                <div class="hero-img">
                    <a href="https://brisbaneeventdecorators.com.au/#event-plan" class="hero-top-btn">See Details</a>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/tc-desk.png" class="hero-desk" alt="">
    ...
    <div class="event-blns">
        <div class="eb-child">
            <h2>Elevate Your Event with Beautifully Styled Tables</h2>
            <p>Transform your dining experience with expertly curated table settings and centerpieces. From intimate gatherings to grand celebrations, we create sophisticated designs that add charm and elegance to every table.</p>

            <div class="eb-sub-child">
                <div class="eb-left">
                    <h2>Why Choose Us for Table Settings & Centerpieces?</h2>
                    <h3>Tailored Styling:</h3>
                    <p>Tailored to match your event’s theme and color palette.</p>
                    <h3>Premium Quality:</h3>
                    <p>Elegant tableware, linens, and centerpieces for a luxurious touch.</p>
                    <h3>Unique Centerpieces: </h3>
                    <p>Creative and stylish focal points that impress your guests.</p>
                    <h3>Seamless Execution:</h3>
                    <p>Flawless setup for a hassle-free experience.</p>
                    <h3>Affordable Packages: </h3>
                    <p>Stunning tablescapes to suit every budget.</p>
                </div>
                <div class="eb-right">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/tc1.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="occations-child">
            ...
            <div class="oc-right">
                <div class="slider-container">
                    <div class="slider">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/tc2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/tc2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/tc2.png" alt="Image 1">
                    </div>
