<?php
/*
Template Name: Prop Event Linen
*/ 
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Event Plinths Linen | Decorating Site</title>
    <?php wp_head(); ?>
    ...
    <link
        ...
        rel='stylesheet'>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/prop-event-linen.css">
...
<body>
    ...
    <section class="parent-section">
        <header class="hero-section">
            ...
            <div class="hero-content">
                <h1>Prop Hire Plinths for Stunning <br>Displays </h1>
                <div class="hero-img">
                    <a href="https://brisbaneeventdecorators.com.au/#event-plan" class="hero-top-btn">See Details</a>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pel-desk.png" class="hero-desk" alt="">
    ...
    <div class="event-blns">
        <div class="eb-child">
            <h2>Elevate Your Event Décor with Stylish Plinths</h2>
            <p>Showcase your decor, desserts, or centerpieces with our elegant plinths. Available in various shapes, sizes, and colors, our plinths add sophistication and focus to your event styling.</p>

            <div class="eb-sub-child">
                <div class="eb-left">
                    <h2>Why Choose Our Plinths?</h2>
                    <h3>Elegant Designs:</h3>
                    <p>Sleek, modern plinths that suit any theme.</p>
                    <h3>Durable Quality:</h3>
                    <p>Sturdy materials for reliable support.</p>
                    <h3>Custom Options: </h3>
                    <p>Available in different sizes and finishes.</p>
                    <h3>Multi-Purpose Use:</h3>
                    <p>Perfect for displaying decor, desserts, or gifts.</p>
                    <h3>Affordable Rentals: </h3>
                    <p>Stylish plinths to fit every budget.</p>
                </div>
                <div class="eb-right">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pel1.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="occations-child">
            ...
            <div class="oc-right">
                <div class="slider-container">
                    <div class="slider">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pel2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pel2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/pel2.png" alt="Image 1">
                    </div>
