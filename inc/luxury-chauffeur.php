<?php
/*
Template Name: Luxury Chauffeur
*/ 
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Luxury Chauffeur | Decorating Site</title>
    <?php wp_head(); ?>
    ...
    <link
        ...
        rel='stylesheet'>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/luxury-chauffeur.css">
...
<body>
    ...
    <section class="parent-section">
        <header class="hero-section">
            ...
            <div class="hero-content">
                <h1>Luxury Chauffeur Services for <br>Every Occasion </h1>
                <div class="hero-img">
                    <a href="https://brisbaneeventdecorators.com.au/#event-plan" class="hero-top-btn">See Details</a>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/lc-desk.png" class="hero-desk" alt="">
    ...
    <div class="event-blns">
        <div class="eb-child">
            <h2>Ride in Style, Comfort, and Safety</h2>
            <p>Experience premium transportation with our professional chauffeur services. From corporate travel to special events, we ensure punctuality, elegance, and a seamless journey every time.</p>

            <div class="eb-sub-child">
                <div class="eb-left">
                    <h2>Why Choose Our Chauffeur Services?</h2>
                    <h3>Experienced Chauffeurs:</h3>
                    <p>Courteous, skilled drivers for a smooth and safe ride.</p>
                    <h3>Luxurious Fleet:</h3>
                    <p>High-end vehicles tailored to your style and comfort.</p>
                    <h3>Timely and Reliable: </h3>
                    <p>Guaranteed punctuality for every journey.</p>
                    <h3>Custom Services:</h3>
                    <p>Tailored packages for business trips, events, and tours.</p>
                    <h3>Affordable Luxury: </h3>
                    <p>Premium service at competitive rates.</p>
                </div>
                <div class="eb-right">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/lc1.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="occations-child">
            ...
            <div class="oc-right">
                <div class="slider-container">
                    <div class="slider">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/lc2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/lc2.png" alt="Image 1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/lc2.png" alt="Image 1">
                    </div>
