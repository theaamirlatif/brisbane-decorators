...
<head>
    ...
    <title>Enquire | Decorating Site</title>
    <?php wp_head(); ?>
    ...
    <link
        ...
        rel='stylesheet'>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/enquire.css">
...
<body>
    ...
    <!--    <div class="wedding-plan-child">-->
    <!--        <div class="wed-content">-->
    <!--            <h2>We Can Make Beautiful Things Together</h2>-->
    <!--            <p>Let us bring your vision to life with creative, personalized decor that makes every event unforgettable.</p>-->
    <!--            <div class="wed-btns">-->
    <!--                <button type="submit" onclick="window.location.href='https://brisbaneeventdecorators.com.au/contact/#service-form';" value="submit">Free Quote</button>-->
    <!--                <a href="tel:+0478706362" alt="call now">Call Now</a>-->
    <!--            </div>-->
    <!--        </div>-->
    <!--    </div>-->
    <!--</div>-->
        ...
        <div class="contact-us-child">
            <div class="cu-social">
                <div class="google-map">
                    <!--<iframe-->
                    <!--    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.687208762497!2d101.44562157403708!3d0.46449686378376376!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31d5afd168f25799%3A0xeb2fdddc9da30d93!2sSultan%20Syarif%20Kasim%20II%20International%20Airport!5e0!3m2!1sen!2s!4v1731563896135!5m2!1sen!2s"-->
            ...
            <div class="cu-info">
                ...
                <h2>Get In Touch.</h2>
                <p>If you need more info related to booking
                    please contact us </p>
                <ul>
                    <li>0478588199, 0478706362</li>
                    <li>Info@brisbaneeventdecorators.com.au</li>
                </ul>
                <h3>Follow Us On</h3>
                <div class="social-icon">
                    <a href="#" class="si-bg"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/Icon.png" alt=""></a>
                    <a href="#" class="si-bg"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/mdi_instagram.png" alt=""></a>
                    <a href="#" class="si-bg"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/twtr.png" alt=""></a>
                    <a href="#" class="si-bg"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/mdi_youtube.png" alt=""></a>
                </div>
            </div>
        </div>
    </div>
