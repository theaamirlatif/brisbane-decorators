<?php
/*
Template Name: Table Chair Services
*/ 
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Table & Chair Services | Decorating Site</title>
    <?php wp_head(); ?>
    ...
    <link
        ...
        rel='stylesheet'>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/assets/css/table-chair-services.css">
